...
book_title_entry.grid(column=1, row=0, pady=2)
...
author_entry.grid(column=1, row=1, pady=2)
...
pages_entry.grid(column=1, row=2, pady=2)
...
update_button.place(relx=0.24, rely=0.775, anchor=tk.N)
...
username_entry.grid(column=1, row=0, pady=2)
...
add_user_button.grid(column=1, row=2, pady=8)
...
username_entry_retrieve.grid(column=1, row=0, pady=2)
...
book_id_entry_delete.grid(column=1, row=0, pady=2)
...
delete_book_button.grid(column=1, row=1, pady=21)
...
username_entry_borrow.grid(column=1, row=0, pady=2)
...
password_entry_borrow.grid(column=1, row=1, pady=2)
...
book_id_entry_borrow.grid(column=1, row=2, pady=2)
...
username_entry_return.grid(column=1, row=0, pady=2)
...
password_entry_return.grid(column=1, row=1, pady=2)
